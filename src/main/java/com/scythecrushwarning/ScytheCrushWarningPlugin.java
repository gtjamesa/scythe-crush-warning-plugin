...
public class ScytheCrushWarningPlugin extends Plugin
{
	...
	{
		log.info("Scythe Crush Warning started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("Scythe Crush Warning stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "Scythe Crush Warning says " + config.greeting(), null);
		}
	}
